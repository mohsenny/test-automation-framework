...
describe("GraphQL Country API Tests", () => {
    const client = new GraphQLClientHelper_1.GraphQLClientHelper(example_config_1.graphqlTestsConfig.apiUrl);
    before(() => {
        client.setHeaders({
    ...
    it("should fetch countries data correctly", () => __awaiter(void 0, void 0, void 0, function* () {
        const data = yield client.sendQuery(countries_testdata_1.sampleQueries.getCountries, undefined, schemas_1.countriesResponseSchema);
    ...
    it("should fetch a specific country", () => __awaiter(void 0, void 0, void 0, function* () {
        const data = yield client.sendQuery(countries_testdata_1.sampleQueries.getCountry, countries_testdata_1.sampleVariables.countryVariables, schemas_1.countryResponseSchema);
