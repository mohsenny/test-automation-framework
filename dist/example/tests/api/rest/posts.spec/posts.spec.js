...
const posts_testdata_1 = require("./testData/posts.testdata");
describe("REST API Posts Tests", () => {
    ...
    it("should fetch posts correctly", () => __awaiter(void 0, void 0, void 0, function* () {
        const posts = yield client.sendRequest('get', posts_testdata_1.postEndpoints.getPosts, undefined, posts_testdata_1.postResponseSchema);
    ...
    it("should fetch a specific post", () => __awaiter(void 0, void 0, void 0, function* () {
        const post = yield client.sendRequest('get', posts_testdata_1.postEndpoints.getPost);
    ...
    it("should handle invalid endpoint correctly", () => __awaiter(void 0, void 0, void 0, function* () {
        try {
            yield client.sendRequest('get', posts_testdata_1.postEndpoints.invalidEndpoint);
